<?php
  ...
  error_reporting(0);
  include '../config.php';
  if ($_SESSION['jabatan'] =="Admin" || $_SESSION['jabatan']=="BK" || $_SESSION['jabatan']=="Tata Usaha" || $_SESSION['jabatan']=="Wakil Kesiswaan") {
...
<div id="main">
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="index.php" class="logo"><img alt="Logo" src="../bootstrap/img/nurul iman.png" /> <span>Konseling</span></a>
        </div>
		...
		<div class="sidebar-inner leftscroll">
			<div id="sidebar-menu">
    			<ul>
					...
					<li class="submenu">
                        <a href="index.php?p=profil"><i class="fa fa-fw fa-user"></i><span> Profil </span> </a>
                    </li>
					<?php
					if($_SESSION['jabatan'] == "Admin"){
						...
						echo '
							<li class="submenu">
								<a href="index.php?p=input-konseling"><i class="fa fa-fw fa-book"></i><span>  Data Konseling </span> </a>
							</li>
							<li class="submenu">
								<a href="index.php?p=point-pelanggaran"><i class="fa fa-fw fa-book"></i><span>  Point Pelanggaran </span> </a>
							</li>
							<li class="submenu">
								<a href="index.php?p=data-point"><i class="fa fa-fw fa-book"></i><span>  Data Pelanggaran </span> </a>
							</li>';
							
							
					}elseif($_SESSION['jabatan'] == "Tata Usaha"){
						echo '
							<li class="submenu">
								<a href="index.php?p=input-jurusan"><i class="fa fa-fw fa-file-text"></i><span>  Data Jurusan </span> </a>
							</li>
							<li class="submenu"> 
								<a href="index.php?p=input-kelas"><i class="fa fa-fw fa-file-text"></i><span>  Data Kelas </span> </a>
							</li>
							<li class="submenu">
								<a href="index.php?p=input-siswa"><i class="fa fa-fw fa-file-text"></i><span>  Data Siswa </span> </a>
							</li>';
					}elseif($_SESSION['jabatan'] == "Wakil Kesiswaan"){
						echo '
							<li class="submenu">
								<a href="index.php?p=input-jurusan"><i class="fa fa-fw fa-file-text"></i><span>  Data Jurusan </span> </a>
							</li>
							...
							<li class="submenu">
								<a href="index.php?p=input-siswa"><i class="fa fa-fw fa-user"></i><span>  Data Siswa </span> </a>
							</li>							
							<li class="submenu">
								<a href="index.php?p=input-konseling"><i class="fa fa-fw fa-book"></i><span>  Data Konseling </span> </a>
							</li>
	...
	<footer class="footer">
		...
		<center>Copyright <a target="_blank" href="#">SMK Nurul Iman Palembang</center></a>
		</span>
