...
$pdf->Cell(0,15,'Data Siswa',0,1,'C');
...
foreach($query as $row){
    ...
    $pdf->Cell(20,10,' '.$row['nis'],1,0,'L',true);
    $pdf->Cell(40,10,' '.$row['nama'],1,0,'L',true);
    $pdf->Cell(30,10,' '.$row['tempat_lahir'],1,0,'L',true);
    $pdf->Cell(20,10,' '.$row['tgl_lahir'],1,0,'L',true);
    $pdf->Cell(50,10,' '.$row['alamat'],1,0,'L',true);
    $pdf->Cell(10,10,' '.$row['jk'],1,0,'L',true);
    $pdf->Cell(30,10,' '.$row['agama'],1,0,'L',true);
...
$pdf->Output("Cetak-DataSiswa.pdf", "I");
