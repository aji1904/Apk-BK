      ...
      <form method="POST" action="includes/simpan-siswa.php">
        ...
        <div class="form-row">
		  ...
		  <div class="col-md-3 mb-3">
            ...
            <div class="input-group">
              <div class="input-group-prepend">
                <label class="input-group-text" for="inputGroupSelect01"><i>Agama</i></label>
              </div>
              <select class="custom-select" id="inputGroupSelect01" name="agama" required="">
          ...
          <table id="example1" class="table table-bordered table-responsive-xl table-hover display" >
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $ambil_data['agama'] ?></td>
                ...
                <td align="center">
                  ...
                  <a href="index.php?p=edit-siswa&id=<?= $ambil_data['nis']?>" class="btn btn-info"><i class="fa fa-pencil"></i></a>
                </td>
                <?php } ?>
              </tr>
              <?php
